...
import (
	...
	"github.com/JesseTrainee/codebank/dto"
	"github.com/JesseTrainee/codebank/infrastructure/grpc/pb"
...
func (t *TransactionService) Payment(ctx context.Context, in *pb.PaymentRequest) (*empty.Empty, error) {
	...
	if transaction.Status != "approved" {
		return &empty.Empty{}, status.Error(codes.FailedPrecondition, "transation rejected by the bank")
	}
